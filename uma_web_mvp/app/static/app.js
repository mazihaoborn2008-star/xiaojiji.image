...
var ERROR_CODE_MAP = {
  ...
  'normal_translation_unavailable':             '普通翻译当前不可用，请稍后重试，或关闭 Agent 润色后提交',
  'insufficient_credits':                       'Credits 不足，请充值后重试',
  'queue_full':                                 '当前生成队列已满，请稍后重试',
  'too_many_active_tasks':                      '你当前未完成的任务已达到10个，请等待任务完成或取消后再提交。',
  'active_task_limit':                          '你当前未完成的任务已达到10个，请等待任务完成或取消后再提交。',
